\def\homeworkname{Calculus and Differential Equations}
...
\begin{document}
    ...
    Solve the differential equation $f' + 2f = x$ with initial condition $f(0) = 0$. Please clarify every step you take.

    \input{texts/solution}
